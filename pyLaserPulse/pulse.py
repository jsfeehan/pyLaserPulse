...
class _pulse_base(ABC):
    ...
    def get_polarization_ellipse_angles(self, field):
        ...
        Notes:
        ------
        Results must be interpreted correctly. pyLaserPulse uses envelope
        equations, and is not carrier resolved. This method calculates the
        general shape of the polarization ellipse, and not the polarization
        state, at any given point along grid.time_window.

        For more information, see J. S. Feehan et al., 'Noise-related
